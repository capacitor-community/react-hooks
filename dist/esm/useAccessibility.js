...
export function useAccessibility() {
    ...
    var _a = useState(false), isScreenReaderEnabled = _a[0], setScreenReaderEnabled = _a[1];
    useEffect(function () {
    ...
    useEffect(function () {
        var listener = Accessibility.addListener('accessibilityScreenReaderStateChange', function () { return __awaiter(_this, void 0, void 0, function () {
            var isEnabled;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Accessibility.isScreenReaderEnabled()];
