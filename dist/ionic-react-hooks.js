/*! Ionic React Hooks: https://ionicframework.com/ - MIT Licensed */
var ionicReactHooks = (function (exports, react) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    function useAccessibility() {
        ...
        var _a = react.useState(false), isScreenReaderEnabled = _a[0], setScreenReaderEnabled = _a[1];
        ...
        react.useEffect(function () {
            var listener = Accessibility.addListener('accessibilityScreenReaderStateChange', function () { return __awaiter$1(_this, void 0, void 0, function () {
                var isEnabled;
                return __generator$1(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Accessibility.isScreenReaderEnabled()];
    ...
    function useAppState() {
        var _this = this;
        var App = Plugins.App;
        var _a = react.useState(true), state = _a[0], setAppState = _a[1];
        react.useEffect(function () {
            var listener = App.addListener('appStateChange', function (state) { return __awaiter$2(_this, void 0, void 0, function () {
        ...
        react.useEffect(function () {
            function getAppLaunchUrl() {
                return __awaiter$2(this, void 0, void 0, function () {
                    ...
                    return __generator$2(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, App.getLaunchUrl()];
                            case 1:
                                ret = _a.sent();
                                setValue(ret.url);
                                return [2 /*return*/];
    ...
    function useAppUrlOpen() {
        var _this = this;
        var App = Plugins.App;
        var _a = react.useState(null), url = _a[0], setAppUrl = _a[1];
        react.useEffect(function () {
            var listener = App.addListener('appUrlOpen', function (state) { return __awaiter$2(_this, void 0, void 0, function () {
                return __generator$2(this, function (_a) {
                    setAppUrl(state.url);
                    return [2 /*return*/];
                });
    ...
    function useBrowser() {
        ...
        function prefetch(urls) {
            return __awaiter$3(this, void 0, void 0, function () {
                return __generator$3(this, function (_a) {
                    return [2 /*return*/, Browser.prefetch({
                            urls: urls
                        })];
                });
            });
        ...
        function getPhoto(options) {
            return __awaiter$4(this, void 0, void 0, function () {
                return __generator$4(this, function (_a) {
                    return [2 /*return*/, Camera.getPhoto(options)];
                });
            });
        }
        return getPhoto;
    ...
    function useClipboard() {
        ...
        var _a = react.useState(''), data = _a[0], setString = _a[1];
    ...
    function useDevice() {
        ...
        var _a = react.useState(null), info = _a[0], setInfo = _a[1];
        var _b = react.useState(null), languageCode = _b[0], setLanguageCode = _b[1];
        react.useEffect(function () {
            function getInfo() {
        ...
        react.useEffect(function () {
            function getLanguageCode() {
                return __awaiter$6(this, void 0, void 0, function () {
                    ...
                    return __generator$6(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Device.getLanguageCode()];
                            case 1:
                                data = _a.sent();
    ...
    function useGeolocation(options) {
        ...
        var _a = react.useState(null), currentPosition = _a[0], setCurrentPosition = _a[1];
        react.useEffect(function () {
    ...
    function useNetwork() {
        ...
        var _a = react.useState(null), networkStatus = _a[0], setStatus = _a[1];
        react.useEffect(function () {
            function getStatus() {
                return __awaiter$7(this, void 0, void 0, function () {
                    ...
                    return __generator$7(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Network.getStatus()];
                            case 1:
                                s = _a.sent();
                                setStatus(s);
                                return [2 /*return*/];
        ...
        react.useEffect(function () {
            var listener = Network.addListener('networkStatusChange', function (status) {
                setStatus(status);
            });
            return function () { return listener.remove(); };
        }, [Network, setStatus]);
    ...
    function useStorageItem(key, initialValue) {
        var _this = this;
        var Storage = Plugins.Storage;
        var _a = react.useState(null), storedValue = _a[0], setStoredValue = _a[1];
        react.useEffect(function () {
            function loadValue() {
                return __awaiter$8(this, void 0, void 0, function () {
                    var value, e_1;
        ...
        var setValue = function (value) { return __awaiter$8(_this, void 0, void 0, function () {
            var e_2;
            return __generator$8(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    exports.useAppLaunchUrl = useAppLaunchUrl;
    exports.useAppState = useAppState;
    exports.useAppUrlOpen = useAppUrlOpen;
...
//# sourceMappingURL=ionic-react-hooks.js.map
